...
public interface AdvancedSearchRepository {
	...
	List<String> API_FILTERABLE = Arrays.asList(new String[] { AdvancedSearchRepository.PAGE_PARAM,
			AdvancedSearchRepository.SIZE_PARAM, AdvancedSearchRepository.SORT_PARAM,
			AdvancedSearchRepository.FILTER_PARAM, AdvancedSearchRepository.FIELDS_PARAM });
